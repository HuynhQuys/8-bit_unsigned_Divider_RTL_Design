...
HD_PWD='D:/New folder/Div8bit_FSM/Div8bit_FSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Div_FSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Div_FSM.tcl -notrace
