...
HD_PWD='D:/New folder/Div8bit_FSM/Div8bit_FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Div_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Div_FSM.tcl
