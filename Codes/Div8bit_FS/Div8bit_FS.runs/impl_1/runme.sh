...
HD_PWD='D:/New folder/Div8bit_FS/Div8bit_FS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DivFS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DivFS.tcl -notrace
