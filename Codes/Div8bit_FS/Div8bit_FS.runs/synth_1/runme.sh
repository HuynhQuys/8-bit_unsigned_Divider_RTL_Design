...
HD_PWD='D:/New folder/Div8bit_FS/Div8bit_FS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DivFS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DivFS.tcl
