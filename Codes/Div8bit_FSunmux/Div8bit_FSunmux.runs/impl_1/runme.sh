...
HD_PWD='D:/New folder/Div8bit_FSunmux/Div8bit_FSunmux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DivFS_unmux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DivFS_unmux.tcl -notrace
