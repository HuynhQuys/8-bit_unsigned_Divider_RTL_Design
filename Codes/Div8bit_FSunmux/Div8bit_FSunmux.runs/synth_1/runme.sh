...
HD_PWD='D:/New folder/Div8bit_FSunmux/Div8bit_FSunmux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DivFS_unmux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DivFS_unmux.tcl
