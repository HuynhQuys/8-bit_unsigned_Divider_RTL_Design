...
HD_PWD='D:/New folder/Div8bit_FAunmux/Div8bit_FAunmux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DivFA_unmux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DivFA_unmux.tcl
