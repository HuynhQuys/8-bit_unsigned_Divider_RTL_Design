...
HD_PWD='D:/New folder/Div8bit_FAunmux/Div8bit_FAunmux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DivFA_unmux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DivFA_unmux.tcl -notrace
