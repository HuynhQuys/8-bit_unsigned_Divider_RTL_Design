...
HD_PWD='D:/New folder/Div8bit_FA/Div8bit_FA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DivFA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DivFA.tcl
