...
HD_PWD='D:/Documents/KT và TC máy tính/Divider 8bit by Verilog/Codes/Div8bit_FA/Div8bit_FA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DivFA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DivFA.tcl -notrace
